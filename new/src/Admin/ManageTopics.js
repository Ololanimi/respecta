                ...
                <div className="admin-wrapper">
                    ...
                    <div  className={sidebar ? "admin-content" : "admin-content admin-content--open"} onClick={toggleSidebar}>
                        <div className="button-group">
                            <div className="creat shishi">
                                <Link className='mn' to="/createtopic">Add Categories</Link>
                            </div>
                            <div className="creat shif">
                                <Link className='mn' to="/">Manage Categories</Link>
                            </div>
                        </div>
                        <div className="content">
                            <h2 className="page-title mto">Manage Topics</h2>
                            <br />
                            <table>
                                <thead>
                                    <th>N</th>
